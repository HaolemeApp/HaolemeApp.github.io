const translations = {
  zh: {
    ...
    featureConsoleTitle: "手机控制台",
    featureConsoleBody: "查看长输出、搜索关键词，并持续加载更早记录。",
  ...
  en: {
    ...
    featureConsoleTitle: "Console on your phone",
    featureConsoleBody: "Read long output, search keywords, and load earlier history only when you need it.",
    ...
    securityTitle: "Your commands should be yours to read.",
